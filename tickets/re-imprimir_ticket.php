...
// CARGAR ENCABEZADO
    ...
    WHERE t.id_ticket = :id_ticket_get and t.estado = '1';
    ");

$query_tickets->bindParam(':id_ticket_get', $id_ticket_get, PDO::PARAM_INT);
...
$pdf = new TCPDF(PDF_PAGE_ORIENTATION, 'mm', array(78,108), true, 'UTF-8', false);

// set document information
$pdf->setCreator(PDF_CREATOR);
$pdf->setAuthor('Josue Felipe');
$pdf->setTitle('Re_Ticket Parking');
...
// INSERTAR DATOS AL PDF POR HTML
$html = '
